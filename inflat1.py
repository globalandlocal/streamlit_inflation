...
zp_2000_2016 = zp_2000_2016.dropna()
zp_2017_2024 = zp_2017_2024.dropna()

st.write("Пример работы с данными:я взял данные с РосСтата по годовой инфляции и годовые изменения зарплат по секторам относительно нее")
